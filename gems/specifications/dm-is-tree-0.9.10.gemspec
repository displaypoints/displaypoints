...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "LICENSE", "Manifest.txt", "README.txt", "Rakefile", "TODO", "lib/dm-is-tree.rb", "lib/dm-is-tree/is/tree.rb", "lib/dm-is-tree/is/version.rb", "spec/spec.opts", "spec/spec_helper.rb", "spec/unit/tree_spec.rb", "tasks/install.rb", "tasks/spec.rb"]
  s.has_rdoc = true
